...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    email = serializers.EmailField(source='user.first_name', read_only=True)
    email = serializers.EmailField(source='user.last_name', read_only=True)
    class Meta:
        model = Customer
        fields = ['id', 'username', 'email', 'image', 'mobile_no', 'address', 'joined']
